...
import { textStyles } from "@/styles/commonStyle/textStyle";
...
const RestaurantReview = () => {
  ...
  // const { restaurantReviews } = useSelectedRestaurant(restaurantId);
  return (
    <div className={styles.container}>
      ...
      <div className={styles.wrapper}>
        ...
        >
          ...
          차돌김치찌개는 깊은 맛이 일품이었습니다. 양도 넉넉해서 배부르게 먹을
          수 있었고, 가격도 합리적이라 가성비가 좋다고 느꼈습니다. 또한, 내부
          인테리어도 깔끔하고 편안한 분위기를 제공해주어 가족, 친구들과 함께
          방문하기 좋은 장소였습니다. 주차 공간도 넉넉하여 접근성이 좋아
          다음에도 꼭 다시 방문하고 싶습니다.
        </div>
      </div>
      <div className={styles.wrapper}>
